...
bash iniciar_dashboard_demo.sh
```
...
- archivos finales de inferencia publicados.

La documentación pública, la release `v1.0.0` y el registro de preservación de dicha versión en Zenodo forman parte del cierre definitivo del proyecto.
...
La primera publicación estable es:
...
**Nota de publicación.** La rama `main` ha recibido actualizaciones documentales posteriores a la publicación de `v1.0.0`, incluida la incorporación de los identificadores de Zenodo y revisiones posteriores de documentación y presentación. Estas modificaciones no alteran la release `v1.0.0` ni el registro de dicha versión archivado en Zenodo.
